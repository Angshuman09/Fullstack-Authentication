    ...
    <div className="w-full min-h-screen bg-linear-to-r from-blue-200 to-pink-200 flex justify-center items-center">
      ...
      {!isEmailSend && (
        <form
          ...
          className="flex justify-center items-center text-center flex-col bg-slate-900 text-white p-4 rounded-2xl w-96"
        >
          ...
          <button className="bg-blue-500 p-2 rounded-3xl w-full hover:bg-blue-600 cursor-pointer">
            Submit
          </button>
        </form>
      )}
